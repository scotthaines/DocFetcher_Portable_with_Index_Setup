...
del ..\exe\DocFetcherPortableWithIndexSetup_1_0_0.exe
...
dir ..\exe\DocFetcherPortableWithIndexSetup_1_0_0.exe /A-D
if 0 EQU %ERRORLEVEL% (
	@echo Run the installer ..\exe\DocFetcherPortableWithIndexSetup_1_0_0.exe now to test it.
